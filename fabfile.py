...
env.project_name = 'probe_project'
env.repository = 'git@github.com:lincolnloop/probe_project.git'
...
def dev():
    ...
    """
    server = 'probe_project.dev.lincolnloop.com'
    env.roledefs = {
        'web': [server],
        'db': [server],
    }
