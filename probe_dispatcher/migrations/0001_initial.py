...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sensor'
        db.create_table(u'probe_dispatcher_sensor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'probe_dispatcher', ['Sensor'])

        # Adding model 'Probe'
        db.create_table(u'probe_dispatcher_probe', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'probe_dispatcher', ['Probe'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'probe_dispatcher_sensor')

        # Deleting model 'Probe'
        db.delete_table(u'probe_dispatcher_probe')
